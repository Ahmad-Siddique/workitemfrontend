...
export default function UpdateMaterial() {
  ...
  const handleAdd = async (e) => {
    ...
    await axios
      .put(
        process.env.REACT_APP_BACKEND_URL + "/material/updatematerial/" + id,
        {
          code,
          name,
          specs,
  ...
  const fetchData = async () => {
    ...
    await axios
      .get(
        process.env.REACT_APP_BACKEND_URL + "/material/getonematerial/" + id
      )
      .then((res) => {
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            ...
            {error && (
              <Alert icon={<CloseIcon fontSize="inherit" />} severity="error">
                Error Occured while Updating material
              </Alert>
            )}
            <form>
